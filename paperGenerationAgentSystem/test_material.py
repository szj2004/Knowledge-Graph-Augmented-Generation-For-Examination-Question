...
import json
import time
from deepseek_mat import api_answer
...
#追加方式写，继承前者
    ...
    for (i, id) in enumerate(id_list):
        ...
        try:
            ...
            if "材料" not in res or "问题" not in res or "答案" not in res:
...
#对材料的一个补丁验证
    # mat1, mat2, ques1, ques2, ans1, ans2=deal("### 材料一：**魏晋时期**，社会动荡，皇权式微，门阀士族逐渐兴起。地方豪强和世族大家 nắm有政治、经济和文化大权，形成了“九品中正制”的选官制度。东汉末年，地方割据势力强大，形成了“天下讻讻，莫能统一”的局面。魏晋南北朝时期，门阀士族进一步发展，成为社会的主要统治力量。这一时期，中央集权逐渐削弱，地方豪强势力膨胀，出现了“州县皆豪族，官司为假名”的现象。**隋唐时期**，随着隋朝的建立和唐朝的统一，中央集权逐渐恢复。隋炀帝开创了科举制度，打破了门阀士族垄断官职的局面。唐太宗时期，政治清明，社会经济繁荣，中央集权制度进一步加强。唐代还确立了三省六部制，科举考试制度也得到了进一步发展和完善。\n### 材料二：在**魏晋时期**，儒家思想逐渐走向衰落，佛教和道教开始兴起。此时，社会动荡，人们追求心灵的慰藉，佛教的传播逐渐兴盛。东汉末年，佛教通过“五胡乱华”时期的大规模传播，逐渐融入中国社会。同时，玄学兴起，成为社会上层士人的新宠。玄学主张“无为而治”，与当时的门阀士族政治思想相契合。**隋唐时期**，随着社会的稳定和经济的发展，儒家思想重新复兴。唐太宗时期，颁布《贞观政要》，强调以德治国。唐玄宗时期，更是以儒家经典作为治国纲领，确立了“以孝治天下”的国策。与此同时，佛教和道教在隋唐时期也得到了进一步的发展，出现了“三教合一”的思想潮流。这为隋唐文化的繁荣奠定了基础。### \n问题一：根据材料一，简述魏晋时期门阀士族的形成及其对政治的影响。答案：  门阀士族是在魏晋时期逐渐形成的，其背景是东汉末年地方豪强势力的崛起，以及曹魏时期九品中正制的确立。门阀士族控制了政治、经济和文化大权，形成了“州县皆豪族，官司为假名”的现象，导致中央集权的削弱，地方势力的膨胀。这使得魏晋南北朝时期的皇权受到严重制约，社会动荡不安。### 问题二：根据材料二，分析魏晋至隋唐时期，佛教、道教与儒家思想的发展变化及其关系。答案：  魏晋时期，佛教和道教兴起，儒家思想逐渐走向衰落。佛教通过“五胡乱华”时期的传播，逐渐融入中国社会；道教则因社会动荡而受到人们的重视。玄学作为一种融合儒家、道家思想的新学说，成为社会上层士人的主流思想。  隋唐时期，儒家思想重新复兴，成为国家的统治思想。唐太宗和唐玄宗时期，儒家经典被确立为治国纲领，科举制度也以儒家经典为考试内容。佛教和道教在隋唐时期得到了进一步的发展，形成了“三教合一”的思想潮流，丰富了隋唐文化的内涵。",3)
    # print(mat1)
    # print(mat2)
    # print(ques1)
    # print(ques2)
    ...
    for method in methods:
        out_path = 'ques_material/' + str(method) + '.json'
        show_path = 'ques_material/' + str(method) + '.txt'
